// src/pages/admin_applicant_manage/admin_applicant_manage.tsx
...
export default function AdminApplicantManage() {
  ...
  // Suppress unused var warning — kept for completeness (Applicant type used via import)
    ...
    try {
      ...
      const mapped: MappedApplicant[] = list
        .map((a: unknown) => {
          ...
          return {
            clubMemberId: (ao?.clubMemberId ?? ao?.club_member_id ?? ao?.id ?? null) as string | number | null,
